...
export const AdminPanel: React.FC = () => {
  ...
  const fetchOrders = async () => {
    try {
      const data = await supabaseApiService.getOrders();
      setOrders(data);
    } catch (error) {
  ...
  const fetchUsers = async () => {
    try {
      const data = await supabaseApiService.getUsers();
      setUsers(data);
    } catch (error) {
  ...
  const updateOrderStatus = async (orderId: string, status: string) => {
    try {
      await supabaseApiService.updateOrderStatus(orderId, status);
  ...
  const updateUserRole = async (userId: string, role: string) => {
    try {
      await supabaseApiService.updateUserRole(userId, role);
